						...
						<tbody>
                                                    ...
                                                    %>
                                                                    ...
                                                                    <%String dnie= String.valueOf(reserva.getDniEmpleado());
                                                                     ...
                                                                     Date fechai = reserva.getIngreso();
                                                                     Date fechae = reserva.getEgreso();
                                                                     SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                                                                     Date fechaComp = formato.parse(fecha);
                                                                     
                                                                     if(!control.dentroDelRango(fechaComp, fechai, fechae)){
                                                                        String fechaEgre= String.format("%1$tY-%1$tm-%1$td", fechae);
                                                                        String fechaIngre= String.format("%1$tY-%1$tm-%1$td", fechai);
                                                                     %>   
                                                                     <tr>
                                                                    <td class="column1"> <%=dnih%> </td>
                                                                    <td class="column2"><%=fechaIngre%></td>
                                                                    <td class="column3"><%=fechaEgre%></td>
